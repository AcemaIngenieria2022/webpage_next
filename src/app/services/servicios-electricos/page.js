  ...
  return (
    <main className={styles.servicePage}>
      <div className={styles.bannerBox}>
        ...
        <Image src="/images/services/banner/electrico-movil.webp" alt="Servicios eléctricos" fill className={styles.bannerImgMobile} sizes="100vw" quality={70} priority fetchPriority="high" loading="eager" decoding="async" />
      </div>
