      ...
      <div className={styles.wrapper}>
        <header className={styles.header}>
          ...
          <p className={styles.description}>
            En ACEMA INGENIERÍA S.A.S. garantizamos la protección y
            confidencialidad de los datos personales de nuestros usuarios,
            clientes, proveedores y colaboradores, en cumplimiento de la Ley
            1581 de 2012, la Ley 1266 de 2008, el Decreto 1377 de 2013 y demás
        ...
        <div className={styles.detailsContainer}>
          <section className={styles.infoBlock}>
            ...
            <p className={styles.textSmall}>
              Nuestros procesos se desarrollan bajo los principios de
              legalidad, finalidad, libertad, transparencia, veracidad,
              seguridad, confidencialidad y conservación limitada de la
              información.
            </p>
          </section>
          ...
          <section className={styles.infoBlock}>
            ...
            <p className={styles.textMedium}>
              Como titular de los datos personales, usted puede:
            </p>
            ...
            <div className={styles.contactInfo}>
              <p>
                Para ejercer estos derechos puede comunicarse con nosotros:
              </p>
          ...
          <section className={styles.infoBlock}>
            ...
            <p className={styles.textSmall}>
              ...
              administrativas para proteger la información. Los datos podrán
              ser transferidos dentro o fuera del país cuando sea necesario
              para fines contractuales, legales u operativos, garantizando
              niveles adecuados de protección y confidencialidad.
            </p>
          </section>
        </div>
        ...
        <footer className={styles.actionFooter}>
          <p className={styles.ctaText}>
            Consulte el documento completo de nuestra política de tratamiento
            de datos personales.
          </p>
